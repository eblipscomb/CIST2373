...
public class Customer{
	...
	private String custPassword;
        ...
        public AccountList cList = new AccountList(); // Lab #4 Part III
	...
	public Customer(String newCustID, String newCustPassword, String newCustFirstName, String newCustLastName, String newCustAddress, String newCustEmail) {
            custID = newCustID;
	...
	public void display() {
		System.out.printf("CustID: %s\nPW: %s\nFN: %s\nLN: %S\nAddress: %s\nEmail: %s\n", 
			custID, custPassword, custFirstName, custLastName, custAddress, custEmail);
                cList.displayAccount(); // Lab #4 Part III
        ...
        public void selectDB(String newCustID) {
            ...
            try {
                ...
                while (rs2.next()) {
                    cList.addAccount(new Account(rs2.getString(1),rs2.getString(2),rs2.getString(3),rs2.getDouble(4)));
                }                              
